...
open class TLabelSegment: TSegmentedControlSegment {
    // MARK: Constants
...
public extension TLabelSegment {
    class func segments(withTitles titles: [String],
                        ...
                        selectedBackgroundColor: UIColor? = nil,
                        selectedFont: UIFont? = nil,
                        selectedTextColor: UIColor? = nil) -> [TSegmentedControlSegment] {
        return titles.map {
            TLabelSegment(text: $0,
